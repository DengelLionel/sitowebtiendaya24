    ...
    <nav className="flex items-center justify-between">
      ...
      <div className="hidden md:flex space-x-4">
          <ul className="flex space-x-4">
            ...
            <li>
              <Link href="/"  className={`text-black2 transition-all duration-150 hover:text-green-500 ${currentPath === '/' ? 'text-green-500' : 'text-black2'}`}>
                INICIO
              </Link>
            </li>
            <li>
            ...
            <li>
              <Link href="/conocenos"    className={`text-black2 transition-all duration-150  hover:text-green-500 ${currentPath === '/conocenos' ? 'text-green-500' : 'text-black2'}`}>
                CONOCENOS
              </Link>
            </li>
            <li>
            ...
            <li>
              <Link href="https://www.tiktok.com/@creatiendaya"  title="TIKTOK"  className={`text-black2 transition-all duration-150 hover:text-green-500 ${currentPath === '/' ? 'text-green-500' : 'text-black2'}`}>
               <IconTiktok/>
              </Link>
            </li>
            <li>
              <Link href="https://www.instagram.com/dengelrivera.dev/"  title="INSTAGRAM"  className={`text-black2 transition-all duration-150 hover:text-green-500 ${currentPath === '/' ? 'text-green-500' : 'text-black2'}`}>
               <IconInstagram/>
              </Link>
            </li>
            <li>
              <Link href="https://www.facebook.com/creatiendaya/"  title="Facebook"  className={`text-black2 transition-all duration-150 hover:text-green-500 ${currentPath === '/' ? 'text-green-500' : 'text-black2'}`}>
