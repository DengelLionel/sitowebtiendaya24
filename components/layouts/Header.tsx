    ...
    <nav className="flex items-center justify-between">
      ...
      <div className="hidden md:flex space-x-4">
          <ul className="flex space-x-4">
            ...
            <li>
              <Link href="/"  className={`text-black2 transition-all duration-150 hover:text-secundary2 ${currentPath === '/' ? 'text-text-secundary2' : 'text-black2'}`}>
                INICIO
              </Link>
            </li>
            <li>
              <Link
                href="#"
                className={`text-black2 transition-all duration-150 hover:text-text-secundary2 ${isSubMenuOpenD ?  'text-text-secundary2' : 'text-black2'} ${
              ...
              {isSubMenuOpenD && (
                <ul className="ml-4 absolute top-[60%] bg-text-secundary2 p-2">
                  {/* Submenu */}
                  <li className='p-[8px]'>
                  ...
                  <li className='p-[8px]'>
                    <Link href="/servicios/diseno-grafico-ecommerce"  className={`text-white transition-all duration-150 hover:text-gray-200 ${
                  ...
                  <li className='p-[8px]'>
                    <Link href="/servicios/mantenimiento-soporte-tienda-online-shopify"  className={`text-white transition-all duration-150 hover:text-gray-200 ${
            ...
            <li>
              <Link href="/conocenos"    className={`text-black2 transition-all duration-150  hover:text-text-secundary2 ${currentPath === '/conocenos' ? 'text-text-secundary2' : 'text-black2'}`}>
                CONOCENOS
              </Link>
            </li>
            <li>
              <span onClick={()=>Scroll("#contactanos")}    className={`text-black2 cursor-pointer transition-all duration-150  hover:text-text-secundary2 ${currentPath === '/contactanos' ? 'text-text-secundary2' : 'text-black2'}`}>
                CONTACTANOS
              </span>
            </li>
            <li>
              <Link href="https://www.tiktok.com/@creatiendaya"  title="TIKTOK"  className={`text-black2 transition-all duration-150 hover:text-text-secundary2 ${currentPath === '/' ? 'text-text-secundary2' : 'text-black2'}`}>
               <IconTiktok/>
              </Link>
            </li>
            <li>
              <Link href="https://www.instagram.com/dengelrivera.dev/"  title="INSTAGRAM"  className={`text-black2 transition-all duration-150 hover:text-text-secundary2 ${currentPath === '/' ? 'text-text-secundary2' : 'text-black2'}`}>
               <IconInstagram/>
              </Link>
            </li>
            <li>
              <Link href="https://www.facebook.com/creatiendaya/"  title="Facebook"  className={`text-black2 transition-all duration-150 hover:text-text-secundary2 ${currentPath === '/' ? 'text-text-secundary2' : 'text-black2'}`}>
