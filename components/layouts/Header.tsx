    ...
    <nav className="flex items-center justify-between">
      ...
      <div className="hidden md:flex space-x-4">
          <ul className="flex space-x-4">
            ...
            <li>
              <Link href="https://www.instagram.com/dengelrivera.dev/"  title="INSTAGRAM"  className={`text-black2 transition-all duration-150 hover:text-secundary2 ${currentPath === '/' ? 'text-secundary2' : 'text-black2'}`}>
               <IconInstagram/>
              </Link>
            </li>
            <li>
              <Link href="https://www.facebook.com/creatiendaya/"  title="Facebook"  className={`text-black2 transition-all duration-150 hover:text-secundary2 ${currentPath === '/' ? 'text-secundary2' : 'text-black2'}`}>
